...
export { SelectProvider, SelectInputProvider, SelectedProvider, SelectedListProvider, SelectActionProvider, useSelectContext, useSelectedContext, useSelectedListContext, useSelectInputContext, useSelectActionContext, };
export declare function useSelect({ create, single, selectionVisibleIn, getDebounce, getOption, stateReducer, filterFn, scrollToIndex, shiftAmount, duplicates, options, value, onChange, placement, }: UseSelectProps): UseSelectReturn;
...
export declare function useSelectedItem(props?: any): {
    key: any;
    onClick: () => void;
